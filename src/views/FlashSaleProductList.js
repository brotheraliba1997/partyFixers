...
function FlashSaleProductList({ setFlashTotal }) {
  ...
  const [searchF, setSearchF] = React.useState('');
  ...
  // console.log("data..", product.map(data => data))
  ...
  useEffect(() => {
    product.map((data) => {
      ...
      total.push(data.discountPrice * data.flashQuantity)
  ...
  return (
    <>
      ...
      <div>
        ...
        {/* <Input type="search" value={searchF} onChange={(e) => setSearchF(e.target.value)} /> */}
      </div>
                ...
                <Table className="table-hover">
                  ...
                  <tbody>
                    {product.filter(data => {
                      ...
                      else if (data.name.toLowerCase().includes(searchF.toLocaleLowerCase())) {
                        return data
                      }
                    }).map((data, i) => (
                      <>
                        <tr key={i}>
                          <>
                            ...
                            // }}
                            >
                              <img width="20%" alt={data.image} src={data.image} />
                            </td>
